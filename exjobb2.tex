...
\input{method/introductionexp.tex}
...
\input{improvements/summary.tex}
...
\input{results/measurements.tex}
\section{Diagnostic plots}
\input{results/diagnostics.tex}
\section{Match to theoretical orbits}
\input{results/matching.tex}


\chapter{Discussion}
\input{discussion/discussion.tex}
\section{Goodness of fit}
\input{discussion/goodnessOfFit.tex}
\section{Automated tracking}
\input{discussion/automatedtracking.tex}
